    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-completed' => [
                'admin-panel'                => '管理员面板',
                'bagisto-forums'             => 'Bizora 论坛',
                'customer-panel'             => '客户面板',
                'explore-bagisto-extensions' => '探索 Bizora 扩展',
                'title'                      => '安装已完成',
                'title-info'                 => 'Bizora 已成功安装在您的系统上。',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => '创建数据库表',
                'install'                 => '安装',
                'install-info'            => 'Bizora 安装信息',
            ...
            'back'                     => '返回',
            'bagisto'                  => 'Bizora',
            'bagisto-info'             => '由 Bizora 社区共同开发的项目',
            ...
            'hindi'                    => '印地语',
            'indonesian'               => '印尼语',
            'installation-description' => 'Bizora 的安装通常涉及几个步骤。以下是 Bizora 安装过程的一般概述',
            'installation-info'        => '我们很高兴在这里见到你！',
            'installation-title'       => '欢迎安装 Bizora',
            'italian'                  => '意大利语',
            'japanese'                 => '日语',
            'persian'                  => '波斯语',
            'polish'                   => '波兰语',
