{{-- Shop by type / Collections section – links to real category pages --}}
@php
    $collections = [
        ['name' => 'Cars', 'image' => 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=600&q=80', 'slug' => 'cars'],
        ['name' => 'Watches', 'image' => 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&q=80', 'slug' => 'watches'],
        ['name' => 'Electronics', 'image' => 'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=600&q=80', 'slug' => 'electronics'],
        ['name' => 'Fashion', 'image' => 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=600&q=80', 'slug' => 'fashion'],
